...
function showJobPage(sJobLocation, iJobID, sjobPost) {
    ...
    switch (sJobLocation) {
        case "redmond":
            window.location.href = "CareerinUS.html?q=" + iJobID + "&pn=" + sjobPost;
            break;
        case "hyderabad":
            window.location.href = "CareersinHyd.html?q=" + iJobID + "&pn=" + sjobPost;
            break;
        case "mumbai":
            window.location.href = "CareersinMumbai.html?q=" + iJobID + "&pn=" + sjobPost;
            break;
    }
}